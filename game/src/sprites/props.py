...
class Bullet(pygame.sprite.Sprite):
    def __init__(self, game, speed, target):
        ...
        self.x, self.y = game.player.rect.x + game.player.width/2 - 12, game.player.rect.y + game.player.height/2 - 10.5
        ...
        self.image = pygame.transform.rotate(self.game.data.bullet_flying[0], self.degree)
    ...
    def update(self):
        ...
        if not self.blowing:
            ...
            if self.animation_loop >= 10:
                self.image = pygame.transform.rotate(self.game.data.bullet_flying[self.animation_position], self.degree)
...
class Attack(pygame.sprite.Sprite):
    ...
    def animate(self):
        self.image = pygame.transform.rotate(self.game.data.attacks[int(self.animation_loop)], self.angle)
